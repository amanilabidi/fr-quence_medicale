...
export default function Post1() {
  ...
  return (
    <>
      <h1 className="post1-title">Les mercredis de la pratique</h1>
      <div className="home">
        <FaHome className="home-icon" />
        <p className="home-text"> Accueil / Les mercredis de la pratique</p>
      </div>
          ...
          <div className="post1-section1-left">
            <div className="mercredi-posts">
              ...
              <div className="mercredi-text">
                <h1>Patient insuffisant cardiaque stable : Risques de ...</h1>
                <div className="post1-description">
                  <FiClock className='icon-desc' />
                  <p>Publié le 27.05.2023 Par  leDr Caroline Pombourcq</p>
                </div>
              </div>
            ...
            <div className="mercredi-posts">
              ...
              />
              <div className="mercredi-text">
                <h1>Une urticaire qui résiste au traitement antihistaminique</h1>
                <div className="post1-description">
                  <FiClock className='icon-desc' />
            ...
            <div className="mercredi-posts">
              ...
              />
              <div className="mercredi-text">
                <h1>1ère poussée d’insuffisance cardiaque chez un homme de</h1>
                <div className="post1-description">
                  <FiClock className='icon-desc' />
                  <p>Publié le 22.04.2023 |Par  le Dr Jean-Paul Marre</p>
                </div>
              </div>
              <button className='left-post1-btn'>Lire La Vidéo</button>
            </div>
            <div className="mercredi-posts">
              ...
              />
              <div className="mercredi-text">
                <h1>Un homme de 65 ans fumeur qui n’a pas fait son 3ème ...</h1>
                <div className="post1-description">
                  <FiClock className='icon-desc' />
                  <p>Publié le 22.03.2023 |Par  le Dr Jean-Paul Marre</p>
                </div>
              </div>
              <button className='left-post1-btn'>Lire La Vidéo</button>
            </div>
            <div className="mercredi-posts">
              ...
              />
              <div className="mercredi-text">
                <h1>Un asthme devenu difficile à traiter chez un homme de 50</h1>
                <div className="post1-description">
                  <FiClock className='icon-desc' />
                  <p>Publié le 21.12.2022 |Par  le Dr Jean-Paul Marre</p>
                </div>
              </div>
              <button className='left-post1-btn'>Lire La Vidéo</button>
            </div>
            <div className="mercredi-posts">
              ...
              />
              <div className="mercredi-text">
                <h1>Prise en charge d’un myélome en rechute chez un homme de ...</h1>
                <div className="post1-description">
                  <FiClock className='icon-desc' />
                  <p>Publié le 19.10.2022 |Par  le Dr Jean-Paul Marre</p>
                </div>
              </div>
              <button className='left-post1-btn'>Lire La Vidéo</button>
            </div>
            ...
            <div className="mercredi-posts">
              ...
              />
              <div className="mercredi-text">
                <h1>Un essoufflement à l’effort chez un ancien fumeur de 63 ...</h1>
                <div className="post1-description">
                  <FiClock className='icon-desc' />
                  <p>Publié le 11.06.2022 |Par  le Dr Jean-Paul Marre</p>
                </div>
              </div>
              <button className='left-post1-btn'>Lire La Vidéo</button>
            </div>
            <div className="mercredi-posts">
              ...
              />
              <div className="mercredi-text">
                <h1>Diabète : traitement à l’ère des nouvelles technologies</h1>
                <div className="post1-description">
                  <FiClock className='icon-desc' />
