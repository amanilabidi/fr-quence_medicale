...
export default function Post1() {
  ...
  return (
    <>
      <h1 className="post1-title">Jeudis des professions de santé</h1>
      <div className="home">
          ...
          <div className="post1-section1-left">
            <div className="mercredi-posts">
              ...
              <div className="mercredi-text">
                <h1>Les troubles de la personnalité : explorer de nouvelles ...</h1>
            ...
            <div className="mercredi-posts">
              ...
              />
              <div className="mercredi-text">
                <h1>La Chirurgie esthétique, comment en parler aux patients</h1>
                <div className="post1-description">
                  <FiClock className='icon-desc' />
            ...
            <div className="mercredi-posts">
              ...
              />
              <div className="mercredi-text">
                <h1>Insuffisance cardiaque, encore un effort !</h1>
                <div className="post1-description">
                  <FiClock className='icon-desc' />
            ...
            <div className="mercredi-posts">
              ...
              />
              <div className="mercredi-text">
                <h1>« Soins Palliatifs » Tout ce qu’il reste à faire… ...</h1>
                <div className="post1-description">
                  <FiClock className='icon-desc' />
            ...
            <div className="mercredi-posts">
              ...
              />
              <div className="mercredi-text">
                <h1>Quelles médecines alternatives et complémentaires en ...</h1>
                <div className="post1-description">
                  <FiClock className='icon-desc' />
