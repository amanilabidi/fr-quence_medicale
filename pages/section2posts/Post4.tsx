...
export default function Post1() {
  ...
  return (
    <>
      <h1 className="post1-title">La chirurgie pour les personnes transgenres</h1>
      <div className="home">
        ...
        <div className="left-post1">
          <div className="post1-section1-left">
            <div className="mercredi-posts">
              ...
              <div className="mercredi-text">
                ...
                <div className="post1-description">
                  ...
                  <p>Publié le 27.05.2023 |Par  le Dr Caroline Pombourcq</p>
                </div>
              </div>
            ...
            <div className="mercredi-posts">
              ...
              />
              <div className="mercredi-text">
                <h1>Diabète, un combat de tous les jours… Pour les malades et...</h1>
                <div className="post1-description">
                  <FiClock className='icon-desc' />
            ...
            <div className="mercredi-posts">
              ...
              />
              <div className="mercredi-text">
                <h1>Dépister et prendre en charge la dépendance</h1>
                <div className="post1-description">
                  <FiClock className='icon-desc' />
            ...
            <div className="mercredi-posts">
              ...
              />
              <div className="mercredi-text">
                <h1>Le virage domiciliaire est une expression nouvelle, du moins ...</h1>
                <div className="post1-description">
                  <FiClock className='icon-desc' />
